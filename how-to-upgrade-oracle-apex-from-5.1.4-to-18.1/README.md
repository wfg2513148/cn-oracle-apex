...
- [Preparation](#preparation)
  ...
  - [Upgrade JDK/JRE 1.8](#upgrade-jdkjre-18)
  - [Upgrade Tomcat Server](#upgrade-tomcat-server)
- [Upgrade APEX 18.1](#upgrade-apex-181)
  - [Execute installation of APEX 18.1](#execute-installation-of-apex-181)
  - [Copy apex static files to tomcat folder](#copy-apex-static-files-to-tomcat-folder)
- [Upgrade ORDS 18.1](#upgrade-ords-181)
  - [Execute installation of ORDS](#execute-installation-of-ords)
  - [Deploy ords.war to Tomcat](#deploy-ordswar-to-tomcat)
